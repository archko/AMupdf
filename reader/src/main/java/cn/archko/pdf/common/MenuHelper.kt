 ...
 */
class MenuHelper public constructor(var mLeftDrawer: RecyclerView?,
    ...
    fun setupMenu(mPath: String?, context: Context, menuListener: MenuListener?) {
        ...
        menus.add(bean)
        bean = MenuBean(context.resources.getString(R.string.menu_progress_outline), MuPDFRecyclerViewActivity.TYPE_PROGRESS)
        menus.add(bean)
        //bean = MenuBean(context.resources.getString(R.string.menu_zoom), MuPDFRecyclerViewActivity.TYPE_ZOOM)
        //menus.add(bean)
        bean = MenuBean(context.resources.getString(R.string.menu_settings), MuPDFRecyclerViewActivity.TYPE_SETTINGS)
        menus.add(bean)
        bean = MenuBean(context.resources.getString(R.string.menu_exit), MuPDFRecyclerViewActivity.TYPE_CLOSE)
        menus.add(bean)
