...
public class ManualCropView extends View {
    ...
    public ManualCropView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ManualCropView(Context context) {
        super(context);
    ...
    public void initControls() {
        ...
        if (oldCb == null) {
            ...
            final RectF ir = new RectF(0, 0, 800, 600);
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        final Drawable d = getContext().getResources().getDrawable(R.drawable.components_cropper_circle);
